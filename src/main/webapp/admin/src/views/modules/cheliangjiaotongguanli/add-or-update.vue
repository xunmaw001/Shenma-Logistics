<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="车辆数量" prop="cheliangshuliang">
          <el-input v-model="ruleForm.cheliangshuliang" 
              placeholder="车辆数量" clearable  :readonly="ro.cheliangshuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="车辆数量" prop="cheliangshuliang">
              <el-input v-model="ruleForm.cheliangshuliang" 
                placeholder="车辆数量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="驾驶人员" prop="jiashirenyuan">
          <el-input v-model="ruleForm.jiashirenyuan" 
              placeholder="驾驶人员" clearable  :readonly="ro.jiashirenyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="驾驶人员" prop="jiashirenyuan">
              <el-input v-model="ruleForm.jiashirenyuan" 
                placeholder="驾驶人员" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          ...
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shiyongqingkuang" label="使用情况" prop="shiyongqingkuang">
                    <span>{{ruleForm.shiyongqingkuang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.cheliangleixing = true;
          ...
          if(o=='cheliangshuliang'){
            this.ruleForm.cheliangshuliang = obj[o];
	    this.ro.cheliangshuliang = true;
            continue;
          }
          if(o=='mingcheng'){
	    ...
	    this.ro.mingcheng = true;
          ...
          if(o=='jiashirenyuan'){
            this.ruleForm.jiashirenyuan = obj[o];
	    this.ro.jiashirenyuan = true;
            continue;
          }
          if(o=='xiangqing'){
    ...
    info(id) {
      this.$http({
        url: `cheliangjiaotongguanli/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `cheliangjiaotongguanli/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.cheliangjiaotongguanliCrossAddOrUpdateFlag = false;
                  this.parent.search();
