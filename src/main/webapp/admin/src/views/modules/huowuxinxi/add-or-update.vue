<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="进价" prop="jinjia">
          <el-input v-model="ruleForm.jinjia" 
              placeholder="进价" clearable  :readonly="ro.jinjia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="进价" prop="jinjia">
              <el-input v-model="ruleForm.jinjia" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="合计金额" prop="hejijine">
            <el-input v-model="hejijine"
                placeholder="合计金额" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.hejijine" label="合计金额" prop="hejijine">
              <el-input v-model="ruleForm.hejijine" 
                placeholder="合计金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="管理员" prop="guanliyuan">
          <el-input v-model="ruleForm.guanliyuan" 
              placeholder="管理员" clearable  :readonly="ro.guanliyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="管理员" prop="guanliyuan">
              <el-input v-model="ruleForm.guanliyuan" 
                placeholder="管理员" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  computed: {
    hejijine: {
      get: function () {
        return 0+parseFloat(this.ruleForm.jinjia==""?0:this.ruleForm.jinjia)+parseFloat(this.ruleForm.shuliang==""?0:this.ruleForm.shuliang) || 0
      }
    },
  },
  created() {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.hejijine = true;
          ...
          if(o=='guanliyuan'){
            this.ruleForm.guanliyuan = obj[o];
	    this.ro.guanliyuan = true;
            continue;
          }
        }
      }
