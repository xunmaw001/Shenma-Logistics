<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="配送员姓名" prop="peisongyuanxingming">
          <el-input v-model="ruleForm.peisongyuanxingming" 
              placeholder="配送员姓名" clearable  :readonly="ro.peisongyuanxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="配送员姓名" prop="peisongyuanxingming">
              <el-input v-model="ruleForm.peisongyuanxingming" 
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.peisongyuanzhaopian" label="配送员照片" prop="peisongyuanzhaopian">
          <file-upload
          tip="点击上传配送员照片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.peisongyuanzhaopian?ruleForm.peisongyuanzhaopian:''"
          @change="peisongyuanzhaopianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.peisongyuanzhaopian" label="配送员照片" prop="peisongyuanzhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.peisongyuanzhaopian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="配送员状态" prop="peisongyuanzhuangtai">
          <el-select v-model="ruleForm.peisongyuanzhuangtai" placeholder="请选择配送员状态">
            <el-option
                v-for="(item,index) in peisongyuanzhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="配送员状态" prop="peisongyuanzhuangtai">
	      <el-input v-model="ruleForm.peisongyuanzhuangtai"
                placeholder="配送员状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	peisongyuanzhaopian : false,
	peisongyuanzhuangtai : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.peisongyuandianhua = true;
          ...
          if(o=='peisongyuanzhaopian'){
            this.ruleForm.peisongyuanzhaopian = obj[o];
	    this.ro.peisongyuanzhaopian = true;
            continue;
          }
          if(o=='peisongyuanzhuangtai'){
            this.ruleForm.peisongyuanzhuangtai = obj[o];
	    this.ro.peisongyuanzhuangtai = true;
            continue;
          }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.peisongyuanzhuangtaiOptions = "在职,离职".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.peisongyuanzhaopian = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
