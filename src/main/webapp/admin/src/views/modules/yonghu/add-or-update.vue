    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="收货地址" prop="shouhuodizhi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="收货地址"
                  v-model="ruleForm.shouhuodizhi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shouhuodizhi" label="收货地址" prop="shouhuodizhi">
                    <span>{{ruleForm.shouhuodizhi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
