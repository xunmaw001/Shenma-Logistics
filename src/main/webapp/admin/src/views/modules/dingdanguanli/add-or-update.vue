  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.huowutupian" label="货物图片" prop="huowutupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.huowutupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="下单日期" prop="xiadanriqi">
          <el-input v-model="ruleForm.xiadanriqi" 
              placeholder="下单日期" clearable  :readonly="ro.xiadanriqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="下单日期" prop="xiadanriqi">
              <el-input v-model="ruleForm.xiadanriqi" 
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="配送日期" prop="peisongriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.peisongriqi" 
                type="date"
                placeholder="配送日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.peisongriqi" label="配送日期" prop="peisongriqi">
              <el-input v-model="ruleForm.peisongriqi" 
                placeholder="配送日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiadanriqi = true;
          ...
          if(o=='peisongriqi'){
            this.ruleForm.peisongriqi = obj[o];
	    this.ro.peisongriqi = true;
            continue;
          }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.dingdanzhuangtaiOptions = "配送中,已送达".split(',')
            this.$http({
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `dingdanguanli/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.dingdanguanliCrossAddOrUpdateFlag = false;
                  this.parent.search();
